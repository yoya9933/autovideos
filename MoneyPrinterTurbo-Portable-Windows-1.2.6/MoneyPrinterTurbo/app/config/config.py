...
if os.getenv("PEXELS_API_KEYS"):
    app["pexels_api_keys"] = [k.strip() for k in os.getenv("PEXELS_API_KEYS").split(",") if k.strip()]
if os.getenv("YOUTUBE_CLIENT_ID"):
    app["youtube_client_id"] = os.getenv("YOUTUBE_CLIENT_ID")
if os.getenv("YOUTUBE_CLIENT_SECRET"):
    app["youtube_client_secret"] = os.getenv("YOUTUBE_CLIENT_SECRET")
if os.getenv("YOUTUBE_REFRESH_TOKEN"):
    app["youtube_refresh_token"] = os.getenv("YOUTUBE_REFRESH_TOKEN")
...
if imagemagick_path and not os.path.isabs(imagemagick_path):
    imagemagick_path = os.path.join(root_dir, imagemagick_path)
if imagemagick_path and os.path.isfile(imagemagick_path):
    os.environ["IMAGEMAGICK_BINARY"] = imagemagick_path

ffmpeg_path = app.get("ffmpeg_path", "")
if ffmpeg_path and not os.path.isabs(ffmpeg_path):
    ffmpeg_path = os.path.join(root_dir, ffmpeg_path)
